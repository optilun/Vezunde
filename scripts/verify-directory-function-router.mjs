...
assert.equal(physicalEndpoints.length, 69, 'Suprafata Base44 trebuie sa contina exact 69 de functii fizice dupa PR 1');
...
for (const absolute of scannedFiles) {
  ...
  for (const match of content.matchAll(invocationPattern)) {
    ...
    if (!physicalEndpoints.includes(logicalName) && !DIRECTORY_FUNCTION_ROUTES[logicalName]) {
