...
const [
  ...
  read('base44/function_modules/createProviderMemberInvitation.ts'),
  read('base44/function_modules/acceptProviderMemberInvitation.ts'),
  read('base44/function_modules/setProviderMemberAccess.ts'),
  read('base44/function_modules/getMyProviderMembers.ts'),
  read('base44/function_modules/revokeProviderMemberInvitation.ts'),
  read('base44/function_modules/syncProviderOrganizationOwnerAccess.ts'),
  read('base44/function_modules/providerLocationExpansionOps.ts'),
