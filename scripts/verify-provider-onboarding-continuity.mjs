...
expect('base44/functions/directoryOps/adminProviderScopedClaimReview.ts', 'approved_location_ids', 'Review-ul canonic permite aprobare partiala explicita');
expect('base44/functions/directoryOps/adminProviderScopedClaimReview.ts', 'Locatia principala trebuie sa ramana inclusa', 'Review-ul canonic pastreaza locatia principala');
expect('base44/functions/directoryOps/adminProviderClaimReview.ts', "const isLocationScopedClaim = claim.mode === 'claim' || submitted.claim_scope === 'location'", 'Review-ul legacy recunoaste cererile vechi de locatie');
expect('base44/functions/directoryOps/adminProviderClaimReview.ts', 'Revendicarea unei locatii nu poate acorda rol de owner al organizatiei', 'Backendul legacy blocheaza escaladarea la owner organizatie');
