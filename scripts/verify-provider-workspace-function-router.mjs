...
assert.deepEqual(logicalNames, expectedLogicalNames, 'Contractul trebuie sa pastreze exact cele 13 nume logice aprobate (inclusiv providerBillingOps) (8 + createProviderCheckoutSession + createProviderBillingPortalSession + syncProviderStripeSubscription + reconcileProviderStripeSubscriptions, 2026-09-11: checkout self-service Stripe pentru planul Pro; sincronizarea s-a mutat de pe webhook, interceptat de platforma Base44, pe confirmare sincrona + resincronizare periodica)');
