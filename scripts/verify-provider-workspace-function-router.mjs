...
await routedClient.functions.invoke('providerOrganizationLeadInboxOps', { organization_id: 'org-1', action: 'list' });
assert.deepEqual(invocations[4], {
  functionName: 'getMyProviderWorkspace',
  payload: { __function: 'providerOrganizationLeadInboxOps', payload: { organization_id: 'org-1', action: 'list' } },
});
