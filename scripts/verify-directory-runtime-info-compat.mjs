...
assert.match(adapter, /DIRECTORY_IMPORT_RUNTIME_REVISION = 'directory-import-runtime-reconciliation-safe-5'/);
assert.match(latestAdapter, /DIRECTORY_IMPORT_RUNTIME_REVISION = 'directory-import-runtime-reconciliation-safe-5'/);
assert.match(frontendRouter, /DIRECTORY_IMPORT_RUNTIME_REVISION = 'directory-import-runtime-reconciliation-safe-5'/);
