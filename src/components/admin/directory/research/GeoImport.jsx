  ...
  return (
    <div className="max-w-3xl space-y-5">
      <AdminCard className="p-5">
        ...
        <p className="text-sm text-muted-foreground mt-1">Sursa canonica de geografie VIASEE. Importul valideaza checksum-ul aprobat inainte de orice scriere. Doar administratori.</p>
