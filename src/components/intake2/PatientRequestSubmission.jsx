...
import { BookmarkPlus, CheckCircle2, LockKeyhole, ShieldCheck } from "lucide-react";
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
              Datele tale de contact nu au fost transmise niciunui furnizor. Distribuirea va necesita o confirmare separată.
            </p>
          </div>
        </div>
      </div>
