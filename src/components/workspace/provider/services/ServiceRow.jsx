  ...
  return (
    ...
    {casVisible && (
      <button
        ...
        className="services-cas-row grid w-full grid-cols-[minmax(0,1fr)_auto] items-center gap-4 border-t border-border/40 px-4 py-2.5 pl-8 text-left transition hover:bg-card/60 disabled:cursor-not-allowed disabled:opacity-55"
      >
