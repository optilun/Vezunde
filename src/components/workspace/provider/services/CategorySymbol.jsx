// Reper de categorie, in stilul favicon-ului VIASEE (2026-08-18), la cererea lui Alex.
// Path-ul e exact cel din /public/brand/viasee-symbol.svg, folosit ca favicon in
// index.html - de-aia arata ca "o steluta intr-un chip colorat": in tab-ul de browser
// simbolul apare pe un fundal colorat, nu ca forma singura. Reproducem exact asta:
// chip rotunjit cu culoarea categoriei ca fundal, simbolul alb inauntru.
...
export default function CategorySymbol({ color, className = "h-5 w-5" }) {
  return (
    ...
    >
      <svg viewBox="0 0 496 427" className="h-[62%] w-[62%]">
        <path
