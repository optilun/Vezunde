    ...
    <section aria-labelledby={headingId} className="relative pb-8 pt-10 sm:pb-10 sm:pt-12 lg:pb-14 lg:pt-12">
      <div className="relative z-10 mx-auto max-w-[84rem] px-5">
        ...
        >
          ...
          <h2 id={headingId} className="mx-auto mt-4 max-w-[68rem] font-heading text-[2.4rem] font-extrabold leading-[0.98] tracking-[-0.055em] min-[390px]:text-[2.7rem] sm:text-[3.5rem] lg:text-[4rem] xl:text-[4.5rem]">
