...
export default function Search() {
  ...
  // DEPRECATED LEGACY FALLBACK (Module 3F.2.3): reading ?oras= free text exists ONLY
  // for old links. It is never generated by new flows, never inferred into a SIRUTA
