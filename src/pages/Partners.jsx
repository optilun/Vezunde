      ...
      <section className="max-w-6xl mx-auto px-5 pt-16 pb-10">
        ...
        <div className="mt-10 grid gap-4 sm:grid-cols-3">
          <div className="rounded-2xl border border-border bg-card p-5">
            ...
            <div className="mt-4 font-semibold">Cautare B2B</div>
            <p className="mt-1 text-sm text-muted-foreground">Opticile si clinicile vor putea cauta furnizori dupa categorie, servicii si zona.</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5">
            <ShieldCheck className="w-5 h-5" />
            <div className="mt-4 font-semibold">Profiluri verificate</div>
            <p className="mt-1 text-sm text-muted-foreground">Furnizorii nu intra in cautarea pacientilor. Apar doar in zona profesionala.</p>
          </div>
          <div className="rounded-2xl border border-border bg-card p-5">
            <CheckCircle2 className="w-5 h-5" />
            <div className="mt-4 font-semibold">Listari platite</div>
            <p className="mt-1 text-sm text-muted-foreground">Monetizarea se va face prin abonamente sau listari pentru parteneri B2B.</p>
          </div>
        </div>
