...
// alege tot el localitatea oficiala din lista SIRUTA.
const LOCALITY_HINTS = [
  { query: "Bucuresti", phrases: ["bucuresti", "capitala"] },
  { query: "Cluj-Napoca", phrases: ["cluj napoca", "cluj"] },
  { query: "Timisoara", phrases: ["timisoara"] },
  { query: "Iasi", phrases: ["iasi"] },
  { query: "Constanta", phrases: ["constanta"] },
  { query: "Craiova", phrases: ["craiova"] },
  { query: "Brasov", phrases: ["brasov"] },
  { query: "Galati", phrases: ["galati"] },
  { query: "Ploiesti", phrases: ["ploiesti"] },
  { query: "Oradea", phrases: ["oradea"] },
  { query: "Braila", phrases: ["braila"] },
  { query: "Arad", phrases: ["arad"] },
  { query: "Pitesti", phrases: ["pitesti"] },
  { query: "Sibiu", phrases: ["sibiu"] },
  { query: "Bacau", phrases: ["bacau"] },
  { query: "Targu Mures", phrases: ["targu mures", "tg mures"] },
  { query: "Baia Mare", phrases: ["baia mare"] },
  { query: "Buzau", phrases: ["buzau"] },
  { query: "Botosani", phrases: ["botosani"] },
  { query: "Satu Mare", phrases: ["satu mare"] },
  { query: "Ramnicu Valcea", phrases: ["ramnicu valcea", "rm valcea"] },
  { query: "Suceava", phrases: ["suceava"] },
  { query: "Piatra Neamt", phrases: ["piatra neamt"] },
  { query: "Drobeta-Turnu Severin", phrases: ["drobeta", "turnu severin"] },
  { query: "Targu Jiu", phrases: ["targu jiu", "tg jiu"] },
  { query: "Tulcea", phrases: ["tulcea"] },
  { query: "Focsani", phrases: ["focsani"] },
  { query: "Bistrita", phrases: ["bistrita"] },
  { query: "Resita", phrases: ["resita"] },
  ...
  { query: "Calarasi", phrases: ["calarasi"] },
  { query: "Giurgiu", phrases: ["giurgiu"] },
  { query: "Zalau", phrases: ["zalau"] },
  { query: "Sfantu Gheorghe", phrases: ["sfantu gheorghe", "sf gheorghe"] },
  { query: "Targoviste", phrases: ["targoviste"] },
  { query: "Miercurea Ciuc", phrases: ["miercurea ciuc"] },
  { query: "Slobozia", phrases: ["slobozia"] },
  { query: "Alexandria", phrases: ["alexandria"] },
  { query: "Medias", phrases: ["medias"] },
  { query: "Turda", phrases: ["turda"] },
  { query: "Roman", phrases: ["roman"] },
  { query: "Barlad", phrases: ["barlad"] },
  { query: "Sighisoara", phrases: ["sighisoara"] },
