...
export const LOCATION_FUNCTIONAL_UNITS = {
  ...
  optical_cabinet: {
    ...
    description: "Spațiu declarat pentru activități de optică, distinct de zona comercială și de cabinetul optometric.",
  ...
  optometry_cabinet: {
    ...
    description: "Spațiu declarat pentru evaluări optometrice, determinarea dioptriilor, vedere binoculară și activități similare.",
    kind: "professional_cabinet",
    defaultCareSetting: "outpatient",
  },
  ophthalmology_office: {
  ...
  ophthalmology_diagnostics: {
    ...
    description: "Spațiu sau zonă în care locația declară că oferă investigații oftalmologice.",
  ...
  ophthalmology_procedure_room: {
    ...
    description: "Spațiu declarat pentru proceduri minore, injecții sau tratamente laser, separat de cabinetul de consultații.",
  ...
  ophthalmology_surgery_unit: {
    ...
    description: "Bloc operator sau unitate chirurgicală declarată de locație pentru intervențiile disponibile.",
