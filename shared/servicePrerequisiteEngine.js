...
const GROUP_EQUIPMENT_DEFAULTS = {
  ...
  technical_activities: { mode: 'any', types: ['tracer', 'blocker', 'edger', 'groover', 'drill', 'polisher', 'ultrasonic_cleaner'] },
};

const SERVICE_POLICY_OVERRIDES = {
  pd_measurement: { equipment_mode: 'any', equipment_types: ['pupillometer', 'digital_centering_system'] },
  digital_centering: { equipment_mode: 'any', equipment_types: ['digital_centering_system'] },

  optometry_consultation: { equipment_mode: 'any', equipment_types: ['visual_acuity_chart', 'phoropter', 'autorefractometer', 'slit_lamp'] },
  ...
  contact_lens_consultation: { equipment_mode: 'any', equipment_types: ['slit_lamp', 'contact_lens_trial_set'] },
  contact_lens_fitting: { equipment_mode: 'all', equipment_types: ['slit_lamp', 'contact_lens_trial_set'] },
  contact_lens_trial: { equipment_mode: 'any', equipment_types: ['slit_lamp', 'contact_lens_trial_set'] },
  contact_lens_followup: { equipment_mode: 'any', equipment_types: ['slit_lamp'] },

  ophthalmology_consultation: { equipment_mode: 'any', equipment_types: ['slit_lamp', 'visual_acuity_chart'] },
  complete_eye_exam: { equipment_mode: 'all', equipment_types: ['slit_lamp', 'visual_acuity_chart'] },
  prescription_check: { equipment_mode: 'any', equipment_types: ['visual_acuity_chart', 'phoropter', 'autorefractometer'] },
  ...
  followup_consultation: { equipment_mode: 'any', equipment_types: ['slit_lamp', 'visual_acuity_chart'] },
  second_opinion: { equipment_mode: 'any', equipment_types: ['slit_lamp', 'visual_acuity_chart'] },
  ...
  children_eye_exam: { professional_types: ['ophthalmologist'], equipment_mode: 'any', equipment_types: ['slit_lamp', 'visual_acuity_chart'] },
  pediatric_refraction: { professional_types: ['optometrist', 'ophthalmologist'], equipment_mode: 'any', equipment_types: ['visual_acuity_chart', 'phoropter', 'autorefractometer'] },
  amblyopia_screening: { professional_types: ['ophthalmologist'], equipment_mode: 'any', equipment_types: ['visual_acuity_chart'] },
  strabismus_screening: { professional_types: ['ophthalmologist'], equipment_mode: 'any', equipment_types: ['visual_acuity_chart'] },
  school_screening: { professional_types: ['optometrist', 'ophthalmologist'], equipment_mode: 'any', equipment_types: ['visual_acuity_chart'] },
  myopia_control_children: { professional_types: ['optometrist', 'ophthalmologist'], equipment_mode: 'any', equipment_types: ['visual_acuity_chart', 'phoropter', 'autorefractometer'] },
  vision_therapy: { professional_types: ['optometrist', 'ophthalmologist'], requires_equipment: false, equipment_types: [] },

  cataract_surgery: { equipment_mode: 'all', equipment_types: ['operating_microscope', 'phacoemulsification_system'], infrastructure_types: ['surgical_infrastructure'] },
  refractive_surgery: { equipment_mode: 'any', equipment_types: ['excimer_laser', 'femtosecond_laser'], infrastructure_types: ['surgical_infrastructure'] },
  laser_procedures: { equipment_mode: 'any', equipment_types: ['yag_laser', 'retinal_laser', 'excimer_laser', 'femtosecond_laser'], infrastructure_types: ['clinical_procedure_infrastructure'] },
  yag_laser: { equipment_mode: 'any', equipment_types: ['yag_laser'], infrastructure_types: ['clinical_procedure_infrastructure'] },
  retinal_laser: { equipment_mode: 'any', equipment_types: ['retinal_laser'], infrastructure_types: ['clinical_procedure_infrastructure'] },
  intravitreal_injections: { equipment_mode: 'any', equipment_types: ['intravitreal_injection_setup'], infrastructure_types: ['clinical_procedure_infrastructure'] },
  eyelid_surgery: { equipment_mode: 'any', equipment_types: ['operating_microscope', 'minor_procedure_set'], infrastructure_types: ['surgical_infrastructure'] },
  chalazion_treatment: { equipment_mode: 'any', equipment_types: ['minor_procedure_set'], infrastructure_types: ['clinical_procedure_infrastructure'] },
  minor_eye_procedures: { equipment_mode: 'any', equipment_types: ['minor_procedure_set'], infrastructure_types: ['clinical_procedure_infrastructure'] },

  eyeglasses_adjustment: { requires_equipment: false, equipment_types: [] },
  eyeglasses_repair: { equipment_mode: 'any', equipment_types: ['drill', 'groover', 'polisher'], infrastructure_types: ['optical_workshop_infrastructure'] },
  lens_fitting: { equipment_mode: 'any', equipment_types: ['tracer', 'blocker', 'edger'], infrastructure_types: ['optical_workshop_infrastructure'] },
  frame_repair: { equipment_mode: 'any', equipment_types: ['drill', 'groover', 'polisher'], infrastructure_types: ['optical_workshop_infrastructure'] },
  screw_replacement: { requires_equipment: false, equipment_types: [] },
  lens_replacement: { equipment_mode: 'any', equipment_types: ['tracer', 'blocker', 'edger'], infrastructure_types: ['optical_workshop_infrastructure'] },
...
const INFRASTRUCTURE_ALIASES = {
  optical_workshop_infrastructure: ['laborator_optic_propriu', 'atelier_service_propriu', 'reparatii_pe_loc', 'montaj_lentile_in_locatie'],
  clinical_procedure_infrastructure: ['clinical_procedure_room', 'sterile_procedure_room', 'day_procedure_unit'],
  surgical_infrastructure: ['operating_room', 'day_surgery_unit', 'surgical_unit'],
};
...
export function getServicePrerequisiteDefinition(rawKey) {
  ...
  const baseEquipment = Array.isArray(base.required_equipment_types) && base.required_equipment_types.length > 0
    ? base.required_equipment_types
    : null;
  const requiredEquipmentTypes = override.equipment_types !== undefined
    ? override.equipment_types
    : (baseEquipment || groupEquipment?.types || []);
  const requiredInfrastructureTypes = override.infrastructure_types !== undefined
    ? override.infrastructure_types
    : (base.requires_infrastructure ? ['clinical_procedure_infrastructure'] : []);

  return {
    ...base,
    required_professional_types: [...(override.professional_types || base.required_professional_types || [])],
    requires_equipment: override.requires_equipment === undefined ? base.requires_equipment : override.requires_equipment,
    required_equipment_types: [...requiredEquipmentTypes],
    equipment_requirement_mode: override.equipment_mode || groupEquipment?.mode || 'all',
...
export function evaluateServicePrerequisites(rawKey, context = {}) {
  ...
  if (!definition) {
    return {
      ...
      definition: null,
      evidence: { verified_professional_types: [], verified_equipment_types: [], active_facility_types: [] },
    };
  }
...
export function servicePrerequisiteStatusLabel(status) {
  const labels = {
    ...
    requires_verified_location: 'Necesita locatie verificata',
